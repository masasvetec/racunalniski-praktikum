...
\[
\text {velikost tabele}=\text {število ur na dan}\cdot \text{število delovnih dni}
\]
...
Imamo torej seznam prepovedanih sprememb -- \textsl{tabujev} in na vsakem koraku za izbrano
...
\begin{enumerate}
   ...
   se zaključi, če po \(n\) korakih še vedno tičimov istem lokalnem maksimumu.
\end{enumerate}
