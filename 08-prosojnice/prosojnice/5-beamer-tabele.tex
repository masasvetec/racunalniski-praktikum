...
\begin{frame}{Odkrivanje tabele po stolpcih}
	...
	\begin{center}
		\begin{tabular}{c|>{\onslide<2->}cccc<{\onslide}}
		   Oznaka & A{\onslide<3->} & B{\onslide<4->} & C{\onslide<5->} & D \\ \hline
		   X & 1{\onslide<3->} & 2{\onslide<4->} & 3{\onslide<5->} & 4 \\
		   Y & 3{\onslide<3->} & 4{\onslide<4->} & 5{\onslide<5->} & 6 \\
		   Z & 5{\onslide<3->} & 6{\onslide<4->} & 7{\onslide<5->} & 8
		\end{tabular}
	\end{center}
\end{frame}
